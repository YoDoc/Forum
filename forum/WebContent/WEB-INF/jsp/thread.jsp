	...
	<div id="wrapcentre">
		<div id="pagecontent">
			...
			<table cellspacing="1" width="100%">
				<tbody>
					<tr>
						<td valign="middle" align="left" colspan="4" nowrap="nowrap"><a href="/forum/home"><img
			...
			<table class="tablebg" cellspacing="1" width="100%">
				<tbody>
					<tr class="row2">
						...
						<td valign="middle" align="center"><b class="postauthor">${topic.auteur.login}</b>
						</td>
				...
				<tr class="row2">
					...
					<td class="profile" valign="top">
						...
						</table> <span class="postdetails"> <b>Posts:</b> requete a faire
					</span>
					...
					<td valign="top">
						<table cellspacing="5" width="100%">
							<tbody>
								<tr>
									<td>
										<div class="postbody">${topic.content}</div> <br clear="all" /> <br />
										<table cellspacing="0" width="100%">
											<tbody>
												<tr valign="middle">
